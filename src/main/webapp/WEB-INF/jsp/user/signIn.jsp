		...
		<div>
			<form method="post" action="/user/sign_in" id="loginForm">
				...
				<div class="d-flex justify-content-center pt-3 pb-3">
					<a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=1f3a717bfeb202d1b0336161e6208697&redirect_uri=http://13.125.206.153:8080/auth/kakao/callback"><img src="/static/img/kakaoLoginBtn.png"></a>
				</div>
			</form>
			<div class="d-flex">
