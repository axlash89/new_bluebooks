...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
	...
	<c:if test="${not empty bookListByCategory }">
	    <div class="book-menus">			
			...
			<a href="/book/all_book_view?cid=55890"><div class="pt-2">건강/취미/레저</div></a>
			...
			<a href="/book/all_book_view?cid=170"><div class="pt-2">경제·경영</div></a>
			...
			<a href="/book/all_book_view?cid=2913"><div class="pt-2">잡지</div></a>	
			<a href="/book/all_book_view?cid=2551"><div class="pt-2">만화</div></a>		
			<a href="/book/all_book_view?cid=1137"><div class="pt-2">청소년</div></a>	
			<a href="/book/all_book_view?cid=1230"><div class="pt-2">가정/요리/뷰티</div></a>	
	    </div>
	</c:if>    
	<c:if test="${not empty bestBookListByCategory }">
	    <div class="book-menus">			
			...
			<a href="/book/best_book_view?cid=55890"><div class="pt-2">건강/취미/레저</div></a>
			...
			<a href="/book/best_book_view?cid=170"><div class="pt-2">경제·경영</div></a>
			...
			<a href="/book/best_book_view?cid=2913"><div class="pt-2">잡지</div></a>	
			<a href="/book/best_book_view?cid=2551"><div class="pt-2">만화</div></a>		
			<a href="/book/best_book_view?cid=1137"><div class="pt-2">청소년</div></a>	
			<a href="/book/best_book_view?cid=1230"><div class="pt-2">가정/요리/뷰티</div></a>	
	    </div>
	</c:if> 
	<c:if test="${not empty newBookListByCategory }">
	    <div class="book-menus">			
			...
			<a href="/book/new_book_view?cid=55890"><div class="pt-2">건강/취미/레저</div></a>
			...
			<a href="/book/new_book_view?cid=170"><div class="pt-2">경제·경영</div></a>
			...
			<a href="/book/new_book_view?cid=2913"><div class="pt-2">잡지</div></a>	
			<a href="/book/new_book_view?cid=2551"><div class="pt-2">만화</div></a>		
			<a href="/book/new_book_view?cid=1137"><div class="pt-2">청소년</div></a>	
			<a href="/book/new_book_view?cid=1230"><div class="pt-2">가정/요리/뷰티</div></a>	
	    </div>
	</c:if>    
